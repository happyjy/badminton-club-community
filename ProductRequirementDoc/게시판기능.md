...
### 카테고리별 권한 설정
- ✅ **구현 완료**: PostCategory.allowedRoles로 카테고리마다 다른 작성 권한 지정
...
- `prisma/build-schema.ts`에 추가 완료
...
1. [ ] 카테고리 탭 컴포넌트 (BoardCategoryTabs)
2. [ ] 게시판 목록 페이지
3. [ ] 게시글 상세 페이지
4. [ ] 게시글 작성/수정 페이지
5. [ ] 댓글 컴포넌트
...
### 기존 코드 패턴
- GuestPost/GuestComment 구조 참고
- ClubNavigation 스타일 참고
